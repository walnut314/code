...
// of a point 
void displayPoint(dpoint P) 
{ 
    printf("(%lf, %lf)\n", P.first, P.second);
} 
  
dpoint lineLineIntersection(dpoint A, dpoint B, dpoint C, dpoint D) 
{ 
...
int main() 
{ 
    dpoint A = make_pair(1, 1); 
    dpoint B = make_pair(4, 4); 
    dpoint C = make_pair(1, 8); 
    dpoint D = make_pair(2, 4); 
  
    dpoint intersection = lineLineIntersection(A, B, C, D); 
