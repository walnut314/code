...
#doskey /exename=powershell.exe lily=cd /d c:\sandbox ^&^& cd ^&^& lilypad
...
doskey /exename=powershell.exe dump=Set-Location -Path "D:\Intel_Dev\Dumps"
doskey /exename=powershell.exe largo=Set-Location -Path "D:\Intel_Dev\Bugs\Largo"
doskey /exename=powershell.exe ffu=Set-Location -Path "D:\Intel_Dev\Bugs\Largo\FFU_Image"
doskey /exename=powershell.exe charts=Set-Location -Path "D:\Intel_Dev\Bugs\Charts"
doskey /exename=powershell.exe bug=Set-Location -Path "D:\Intel_Dev\Bugs"
