...
#define NTDEVICE_NAME_STRING      L"\\Device\\PST"
#define SYMBOLIC_NAME_STRING     L"\\DosDevices\\PST"
...
EVT_WDF_DRIVER_UNLOAD PstEvtDriverUnload;

EVT_WDF_DEVICE_CONTEXT_CLEANUP PstEvtDriverContextCleanup;
EVT_WDF_DEVICE_SHUTDOWN_NOTIFICATION PstShutdown;
...
EVT_WDF_IO_IN_CALLER_CONTEXT PstEvtDeviceIoInCallerContext;
EVT_WDF_DEVICE_FILE_CREATE PstEvtDeviceFileCreate;
EVT_WDF_FILE_CLOSE PstEvtFileClose;
