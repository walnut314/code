...
#pragma alloc_text( PAGE, PstEvtDriverContextCleanup)
#pragma alloc_text( PAGE, PstEvtDriverUnload)
#pragma alloc_text( PAGE, PstEvtDeviceIoInCallerContext)
#pragma alloc_text( PAGE, PstEvtDeviceFileCreate)
#pragma alloc_text( PAGE, PstEvtFileClose)
...
--*/
{
    ...
    KdPrint(("Driver Frameworks PST Legacy Driver Example\n"));
    ...
    //
    // Pst driver must explicitly register an unload routine for
    ...
    attributes.EvtCleanupCallback = PstEvtDriverContextCleanup;
    ...
    if (!NT_SUCCESS(status)) {
        KdPrint (("Pst: WdfDriverCreate failed with status 0x%x\n", status));
        return status;
    }
    ...
    //
    KdPrint(("Pst: DriverEntry: tracing enabled\n"));

    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_INIT,
                   "Driver Frameworks PST Legacy Driver Example");
    ...
    //
    // Call PstDeviceAdd to create a deviceobject to represent our
    // software device.
    //
    status = PstDeviceAdd(hDriver, pInit);
...
{
    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_INIT,
                        "Entered PstEvtDriverContextCleanup\n");
...
--*/
{
    ...
    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_INIT, "PstEvtDeviceFileCreate %wZ%wZ",
                   &directory, fileName);
...
--*/
{
    ...
    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_INIT, "PstEvtFileClose\n");
...
--*/
{
    ...
    case IOCTL_PST_METHOD_BUFFERED:
        ...
        TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Called IOCTL_PST_METHOD_BUFFERED\n");
    ...
    case IOCTL_PST_METHOD_IN_DIRECT:


        TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Called IOCTL_PST_METHOD_IN_DIRECT\n");
    ...
    case IOCTL_PST_METHOD_OUT_DIRECT:


        TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Called IOCTL_PST_METHOD_OUT_DIRECT\n");
    ...
    case IOCTL_PST_METHOD_NEITHER:
        {
            size_t inBufLength, outBufLength;

            //
            // The PstEvtDeviceIoInCallerContext has already probe and locked the
            ...
            //
            TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Called IOCTL_PST_METHOD_NEITHER\n");
...
--*/
{
    ...
    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Entered PstEvtDeviceIoInCallerContext %p \n",
                            Request);
...
--*/
{
    ...
    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_INIT, "Entered PstDriverUnload\n");
