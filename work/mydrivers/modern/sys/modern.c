...
--*/
{
    ...
    WdfDeviceInitSetIoInCallerContextCallback(DeviceInit,
                                    ModernEvtDeviceIoInCallerContext);
...
--*/
{
    ...
    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_INIT, "ModernEvtDeviceFileCreate %wZ%wZ",
                   &directory, fileName);
...
--*/
{
    ...
    case IOCTL_MODERN_METHOD_IN_DIRECT:


        TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Called IOCTL_MODERN_METHOD_IN_DIRECT\n");
    ...
    case IOCTL_MODERN_METHOD_OUT_DIRECT:


        TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Called IOCTL_MODERN_METHOD_OUT_DIRECT\n");
        // Get the Input buffer. WdfRequestRetrieveInputBuffer returns
        // Irp->AssociatedIrp.SystemBuffer.
        status = WdfRequestRetrieveInputBuffer(Request, 0, &inBuf, &bufSize);
        if(!NT_SUCCESS(status)) {
    ...
    case IOCTL_MODERN_METHOD_NEITHER:
        {
            size_t inBufLength, outBufLength;
            // The ModernEvtDeviceIoInCallerContext has already probe and locked the
            ...
            TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Called IOCTL_MODERN_METHOD_NEITHER\n");
...
--*/
{
    ...
    TraceEvents(TRACE_LEVEL_VERBOSE, DBG_IOCTL, "Entered ModernEvtDeviceIoInCallerContext %p \n",
                            Request);
